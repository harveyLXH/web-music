...
const HYAppPlayerBar = memo(() => {
  ...
  const shhowDuration = formatDate(duration, "mm:ss");
  ...
  const sliderAferChange = useCallback((value) => {
          ...
          <div className="info">
            ...
            <div className="progress">
              <Slider
                ...
                onAfterChange={sliderAferChange}
              />
              <div className="time">
                <span className="now-time">{showCurrentTime}</span>
                <span className="divider">/</span>
                <span className="duration">{shhowDuration}</span>
              </div>
            </div>
          </div>
        </PlayInfo>
        <Operator sequence={sequence}>
          ...
          <div className="right sprite_player">
            ...
            <button className="sprite_player btn playlist">
              <span className="countSong">{playList.length}</span>
            </button>
          </div>
        </Operator>
      </div>
